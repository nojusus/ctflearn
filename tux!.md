...
binwalk -e Tux.jpg
```
and a new file "1570.zip" can be found. Running the command
```bash
unzip 1570.zip
```
and entering the password that was found previously, the flag file is extracted, and the flag can be read using
```bash
cat flag
```
